...
export default function NotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 pt-[var(--header-height)] text-center">
      ...
      <Link
        href="/"
        className="mt-6 inline-flex h-11 items-center justify-center rounded-sm bg-primary-600 px-5 text-sm font-medium text-white transition-colors hover:bg-primary-700"
      >
        Back to Home
      </Link>
    </div>
